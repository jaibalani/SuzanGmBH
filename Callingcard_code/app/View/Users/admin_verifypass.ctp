    ...
    <div class="row">
		<div class="col-md-4 col-md-offset-4">
    		<div class="panel panel-default panel-primary">
			  	...
			  	<div class="panel-body">
                    ...
                    <fieldset>
			    	  <div class="form-group input-group">
			    	  		<span class="input-group-addon" style="width:145px;text-align:left;">Password&nbsp;</span>
			    			<?php 
              ...
              <div class="form-group input-group">
			    	  		<span class="input-group-addon" style="width:145px;text-align:left;">Confirm Password&nbsp;</span>
