...
change_background_text();
   ...
   <div class="intro-header">
        <div class="container">
            <div class="row">
                <div class="col-xs-7 cms_page_div">
                    <div class="intro-message">
                        <h3 class="front-text"><?php echo $content['CmsLanguage']['title'];?></h3>
                        <?php foreach($cms_image as $rec){?>
                      	<?php 
                        	echo $this->Html->image("admin_uploads/cms_uploads/".$rec['CmsImage']['image'],																																		array('border' =>'0','width'=>'1000')); 
                        	}
                      	?>
                        <p class="front-text">
                        ...
                        <div class="home-social">
                        		 <a target="_blank" href="<?php echo $facebook;?>"><i class="fa fa-facebook fa-lg"></i></a>
                            	<a target="_blank" href="<?php echo $twitter;?>"><i class="fa fa-twitter fa-lg"></i></a>
                            	<a target="_blank" href="<?php echo $googleplus;?>"><i class="fa fa-google-plus fa-lg"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-5">
                    <div class="loginBox">
                        ...
                        <div class="loginform">
                            ...
                            <?php echo $this->Form->input('username',array('label'=>false,'placeholder'=>__('Account Number'),'required'=>true,'value'=>isset($cookie_username)?$cookie_username:'')); ?>
                            ...
                            <div class="switch">
                                ...
                                <input id="cmn-toggle-1" class="cmn-toggle cmn-toggle-round" type="checkbox" name="remember_me" style="width:30px; height:25px;">
