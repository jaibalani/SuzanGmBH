...
-->
  <div class="sub_title"><i class="icon-user home_icon"></i> <span class="sub_litle_m">Retailer</span> <i class="icon-angle-right home_icon"></i> <span>Manage Retailer</span></div>
  <div class="main_subdiv">
    <div class="gird_button">
        ...
        <button class="new_button new_button_right" id="add_button"  style="float:right;margin-right:10px;" type="button" onclick="add_user();"><span class="icon-plus icon-white"></span>&nbsp;&nbsp;Add New</button>
        <button class="new_button new_button_right" id="send_mail"  style="float:right;margin-right:10px;" type="button" onclick="send_mail();"><span class="icon-envelope icon-white"></span>&nbsp;&nbsp;Send Mail</button>
...
$(function(){ 
    var lastSel;
  $("#list").jqGrid({
    url:'<?php echo $this->Html->url(array("controller" => "Users","action" => "generategrid_retailer",'admin'=>true));?>',
    datatype: "json",
    mtype: 'GET',
...
var rowid;
	...
	$('.clear_filer_class').click(function(){
 		var new_url = "<?php echo $this->Html->url(array('controller'=>'Users','action'=>'generategrid_retailer','admin'=>'true'));?>";
