...
-->
  <div class="sub_title"><i class="icon-user home_icon"></i> <span class="sub_litle_m">Minimum Balance</span> <i class="icon-angle-right home_icon"></i> <span></span></div>
...
$(function(){ 
  $("#list").jqGrid({
    url:'<?php echo $this->Html->url(array("controller" => "Transactions","action" => "generategrid_minimum_balance_retailer",'admin'=>true));?>',
    datatype: "json",
    mtype: 'GET',
...
$(document).ready(function(){
   $('#retailer_active').addClass('sb_active_single_opt');
 }) ;
...
$('.clear_filer_class').click(function(){
 		var new_url = "<?php echo $this->Html->url(array('controller'=>'Transactions','action'=>'generategrid_minimum_balance_retailer','admin'=>'true'));?>";
