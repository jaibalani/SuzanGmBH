...
.sb_active_single_opt{ 
    ...
    background-image: url(/ecom/img/aroow.png);
...
.sb_active_opt{
    ...
    color: #fff !important;
    vertical-align: top !important; 
    background-image: url(/ecom/img/down_arrow.png), url(/ecom/img/aroow.png);
...
.has_submenu{ background-image: url(/ecom/img/right_arrow.png);
    background-repeat: no-repeat;
...
?>
   ...
   <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
     ...
     <div class="navbar-header">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav left-panel" id="sb_left_menu">
   ...
   <?php if($login_user_roleid == 1) { ?>
    ...
    <li>
        <a id="Mediator" href="javascript:;" class="hidden_sub <?php echo $active_manage; ?>"><i class="icon-user"></i><?php echo __('Manage Mediator');?></a>
    	<ul class ="navigation"> 
    		...
    		<li><a id="retailer_active" href="#"><?php echo __('View Retailers');?></a></li>
    ...
    <li>
    	...
    	<ul class ="navigation"> 
    		...
    		<li><a id="addcard_active" href="<?php echo Router::url(array('controller'=>'Cards', 'action'=>'add')); ?>"><?php echo __('Add Card');?></a></li>
    	   </ul>
    </li>
    <li>
        <a id="pin" href="javascript:;" class="hidden_sub <?php echo $active_pin; ?>"><i class="icon-list-alt"></i><?php echo __('PIN Management');?></a>
    	<ul class ="navigation"> 
            <li><a id="addlist_active" href="<?php echo Router::url(array('controller'=>'Cards', 'action'=>'index','admin'=>true)); ?>"><?php echo __('Card List');?></a></li>
    ...
    <li>
    	...
    	<ul class ="navigation"> 
            <li><a id="websetting_active" href="<?php echo Router::url(array('controller'=>'Settings', 'action'=>'edit','Site')); ?>"><?php echo __('Edit WebSettings');?></a></li>
    ...
    <li><a class="sb_online_card" href="<?php echo Router::url(array('controller'=>'Searches', 'action'=>'index')); ?>"><i class="icon-barcode"></i><?php echo __('Online Cards');?></a></li>
    ...
    <?php } else { ?>
    <li>
        <a id="retailer" href="javascript:;" class="hidden_sub <?php echo $active_ret; ?>"><i class="icon-user"></i><?php echo __('Manage Retailer');?></a>
    	<ul class ="navigation"> 
            <li><a href="<?php echo Router::url(array('controller'=>'Users', 'action'=>'manage_retailer')); ?>"><?php echo __('Manage Retailer');?></a></li>
            <li><a  href="<?php echo Router::url(array('controller'=>'Transactions', 'action'=>'manage_fund_retailer')); ?>"><?php echo __('Manage Fund');?></a></li>
    		<li><a href="<?php echo Router::url(array('controller'=>'Cards', 'action'=>'manage_price_mediator','admin'=>true)); ?>"><?php echo __('Manage Price');?></a></li>
    	   </ul>
    </li>
