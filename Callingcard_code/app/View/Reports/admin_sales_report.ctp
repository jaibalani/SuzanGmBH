...
$('#filter_card_button').click(function(){
 ...
 {
 	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'sales_report'));?>/"+retailer_id+"/"+card_id+"/"+url_start_date+"/"+url_end_date+"/"+cat_id+"/"+sub_cat_id;
 }
 else
 {
 	url_start_date = null;
...
$('#excel_sales').click(function(){
 ...
 if(length_start != 0 && length_end !=0)
 {
 	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'sales_report_excel'));?>/"+cat_id+ "/" + sub_cat_id + "/" +retailer_id+"/"+card_id+"/"+url_start_date+"/"+url_end_date;
 }
 else
 {
 	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'sales_report_excel'));?>/"+cat_id+ "/" + sub_cat_id + "/" +retailer_id+"/"+card_id;
 }
 window.location.href = url;
...
function single_excel_report(sales_id)
{
	...
	var url_end_date = 0;
	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'sales_report_excel'));?>/"+cat_id+"/"+sub_cat_id+"/"+retailer_id+"/"+card_id+"/"+url_start_date+"/"+url_end_date+"/"+sales_id;
    window.location.href = url;
}
...
$('.clear_filer_class').click(function(){
	var new_url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'sales_report','admin'=>'true'));?>";
