...
-->
	<div class="sub_title">
		...
		<i class="icon-angle-right home_icon"></i> <span>Profitability Report</span>
	</div>
		...
		<div align="left" class="grid_table_box">
			...
			<div class="selectbox_div">
				<div class="col-md-4 " align="left"
					style="margin-right: 10px; padding-left: 0px !important;">
...
echo $this->Form->input ( 'datepicker2', array (
			...
			<div class="row">
				...
				<div class="col-md-2 selectbox_title"  style="margin-left: 9px;">Download Excel Report</div>
...
$('#filter_card_button').click(function(){
 ...
 {
 	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'profit_profile_distributor'));?>/"+mediator_id+"/"+retailer_id+"/"+card_id+"/"+url_start_date+"/"+url_end_date+ "/" + cat_id + "/" + sub_cat_id;
 }
 else
 {
    url_start_date = null;
 ...
 window.location.href = url;
    ...
    $('#CatId').change(function () {
        ...
        /*var url = "<?php echo $this->Html->url(array('controller' => 'Reports', 'action' => 'profit_profile_distributor')); ?>/"+0+"/"+0+"/"+0+"/"+url_start_date+"/"+url_end_date + "/" + cat_id + "/" + sub_cat_id;
        window.location.href = url;*/
			 var sub_cat_id =  '';
 		     var card_id =  '';
			 $.ajax({
...
$('#excel_sales').click(function(){
 ...
 else
 {
	...
	var start_timestamp = new_start.getTime();
	var end_timestamp = new_end.getTime();
	//alert(end_timestamp+' - '+start_timestamp);
	/*if(start_timestamp > end_timestamp)
	{
		 alert("<?php echo __('Invalid date range.');?>");
		 $("#datepicker1").css('border','1px solid #F00');
 ...
 if(length_start != 0 && length_end !=0)
 {
 	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'profit_profile_excel_distributor'));?>/" +cat_id+ "/" + sub_cat_id+ "/" + mediator_id+"/"+retailer_id+"/"+card_id+"/"+url_start_date+"/"+url_end_date;
 }
 else
 {
 	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'profit_profile_excel_distributor'));?>/" +cat_id+ "/" + sub_cat_id+ "/" + mediator_id+"/"+retailer_id+"/"+card_id;
 }
 window.location.href = url;
...
function single_excel_report(sales_id)
{
	...
	var url_end_date = 0;
	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'profit_profile_excel_distributor'));?>/"+cat_id+ "/" + sub_cat_id+ "/" +mediator_id+"/"+retailer_id+"/"+card_id+"/"+url_start_date+"/"+url_end_date+"/"+sales_id;
    window.location.href = url;
}
...
$('.clear_filer_class').click(function(){
	 ...
	 var new_url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'profit_profile_distributor','admin'=>'true'));?>";
