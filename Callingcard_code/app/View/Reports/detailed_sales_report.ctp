...
<div class="right-part right-panel">
   ...
   <?php } ?>
   <?php $previou_cat =$data_sales['main_cat_title'];
             $counter++;
...
<script type="text/javascript">
    ...
    $('#print').click(function(){
      ...
      var report_name = "<div style='font-weight:bold;font-size:14px;'><?php echo __('Detailed Sales Report');?></div>";
       ...
       var new_style = '<style>.filters{display : none; } a{color:#333333 !important;}thead>tr>th{border-bottom:2px solid #CCCCCC;border-top:2px solid #CCCCCC; padding-bottom:5px;font-size:12px;}tfoot>tr>td{border-bottom:2px solid #CCCCCC;border-top:2px solid #CCCCCC; padding-bottom:5px;padding-top:5px;font-size:12px;}tbody>table-bordered{border:none !important;}tbody>tr>td{font-size:12px;}.sb-page-title{display:none;}#sr-date-range{display:none;}.new_cat_sub_cat,.new_cat,.main_print_div sales-reports,.total_sub_cat{font-size:12px;font-weight:bold;}.new_cat{margin-top:10px;font-size:14px;margin-bottom:10px;},.new_cat_sub_cat{margin-top:10px !important;} </style>';

       var thePopup = window.open( '', "DetailedSalesReport", "menubar=0,location=0,height=700,width=700" );
            thePopup.document.write(report_name+$('.right-panel').html()+new_style);
