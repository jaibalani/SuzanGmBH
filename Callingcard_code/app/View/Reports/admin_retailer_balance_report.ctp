...
-->
	...
	<div class="main_subdiv">
		...
		<div align="left" class="grid_table_box">
			...
			<div class="row">
			<div class="col-md-4">
				<div class="col-md-5" style="">Select Retailer</div>
				<div class="col-md-7">	 
			<?php
...
$(document).ready(function(){
   ...
   $('#retailer_balance_report').addClass('sb_active_subopt_active');
...
$('#filter_card_button').click(function(){
 ...
 if(retailer_id == '' || retailer_id.length == 0)
  retailer_id = 0;
 	...
 	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'retailer_balance_report'));?>/"+retailer_id;
...
$('#excel_sales').click(function(){
 ...
 var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'retailer_balance_report_excel'));?>/" +retailer_id;
...
{
 	var retailer_id = 0;
	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'retailer_balance_report_excel'));?>/" +retailer_id+"/"+transaction_id;
    window.location.href = url;
}
...
$('.clear_filer_class').click(function(){
	var new_url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'retailer_balance_report','admin'=>'true'));?>";
