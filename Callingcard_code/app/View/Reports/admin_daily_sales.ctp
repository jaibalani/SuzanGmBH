...
-->
  <div class="sub_title"><i class="icon-user home_icon"></i> <span class="sub_litle_m">Reports</span> <i class="icon-angle-right home_icon"></i> <span>Daily Sales Report</span></div>
...
<div class="selectbox_div">
                ...
                <div class="col-md-4 " align="right" style="padding-left: 0px;">
                	<div class="col-md-5">
...
$('#filter_card_button').click(function(){
 ...
 {
 	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'daily_sales'));?>/"+retailer_id+"/"+url_start_date+"/"+url_end_date;
 }
 else
 {
 	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'daily_sales'));?>/"+retailer_id;
 }
...
$('#excel_sales').click(function(){
 ...
 if(length_start != 0 && length_end !=0)
 {
 	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'daily_sales_excel'));?>/"+retailer_id+"/"+url_start_date+"/"+url_end_date;
 }
 else
 {
 	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'daily_sales_excel'));?>/"+retailer_id;
 }
 window.location.href = url;
...
function single_excel_report(sales_user_id,sales_date)
{
	...
	var url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'daily_sales_excel'));?>/"+retailer_id+"/"+url_start_date+"/"+url_end_date+"/"+sales_user_id+"/"+sales_date;
...
$('.clear_filer_class').click(function(){
	var new_url = "<?php echo $this->Html->url(array('controller'=>'Reports','action'=>'daily_sales','admin'=>'true'));?>";
