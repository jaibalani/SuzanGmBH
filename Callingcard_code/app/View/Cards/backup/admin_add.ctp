...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="sub_title"><i class="icon-list-alt home_icon"></i> <span class="sub_litle_m">PIN Management</span> <i class="icon-angle-right home_icon"></i> <span>Add Card</span></div>
  </div>
</div>
...
<div class="main_subdiv">
	...
	<div align="left" class="grid_table_box">
		...
		<div class="clear10"></div>
		<div class="row">
		  <div class="col-md-3"><?php echo __('Main Category')?><sup class="MandatoryFields">*</sup></div>
		  <div class="col-md-6">
		  <?php echo $this->Form->input('Card.cat_id',array(
												  'label' 	 => false, 
												  'required' => true, 
												  'id' 	 => 'cat_id',
												  'default'	 => '',
		...
		<div class="row">
		  <div class="col-md-3"><?php echo __('Card Name')?><sup class="MandatoryFields">*</sup></div>
		  <div class="col-md-6">
		...
		<div class="row">
		  <div class="col-md-3"><?php echo __('Buying Price')?> &euro;<sup class="MandatoryFields">*</sup></div>
		  <div class="col-md-6">
		...
		<div class="row">
		  <div class="col-md-3"><?php echo __('Selling Price')?> &euro;<sup class="MandatoryFields">*</sup></div>
		  <div class="col-md-6">
		...
		<div class="row">
		    <div class="col-md-3"><?php echo __('German Contact Number')?></div>
		    <div class="col-md-6">
		        <?php echo $this->Form->input('c_contact_number_1',array('class'=>'form-control contact_number',
																											'type' =>'text',
																											'required' =>false,
																											'label'=>false,
																											'div'	 => false)); ?>
		...
		<div class="row">
		    <div class="col-md-3"><?php echo __('English Contact Number')?></div>
		    <div class="col-md-6">
		        <?php echo $this->Form->input('c_contact_number_2',array('class'=>'form-control contact_number',
																											'type' =>'text',
																											'required' =>false,
																											'label'=>false,
																											'div'	 => false)); ?>
		...
		<div class="row">
		    <div class="col-md-3"><?php echo __('Local Contact Number - 1')?></div>
		    <div class="col-md-6">
		        <?php echo $this->Form->input('c_local_number_1',array('class'=>'form-control contact_number',
																											'type' =>'text',
																											'required' =>false,
																											'label'=>false,
																											'div'	 => false)); ?>
		...
		<div class="row">
		    <div class="col-md-3"><?php echo __('Local Contact Number - 2')?></div>
		    <div class="col-md-6">
		        <?php echo $this->Form->input('c_local_number_2',array('class'=>'form-control contact_number',
																											'type' =>'text',
																											'required' =>false,
																											'label'=>false,
																											'div'	 => false)); ?>
		...
		<div class="row">
		    <div class="col-md-3"><?php echo __('Local Contact Number - 3')?></div>
		    <div class="col-md-6">
		        <?php echo $this->Form->input('c_local_number_3',array('class'=>'form-control contact_number',
																											'type' =>'text',
																											'required' =>false,
																											'label'=>false,
																											'div'	 => false)); ?>
		...
		<div class="row">
		    <div class="col-md-3"><?php echo __('Local Contact Number - 4')?></div>
		    <div class="col-md-6">
		        <?php echo $this->Form->input('c_local_number_4',array('class'=>'form-control contact_number',
																											'type' =>'text',
																											'required' =>false,
																											'label'=>false,
																											'div'	 => false)); ?>
		...
		<div class="row">
		    <div class="col-md-3"><?php echo __('Local Contact Number - 5')?></div>
		    <div class="col-md-6">
		        <?php echo $this->Form->input('c_local_number_5',array('class'=>'form-control contact_number',
																											'type' =>'text',
																											'required' =>false,
																											'label'=>false,
																											'div'	 => false)); ?>
		...
		<div class="row">
		    <div class="col-md-3"><?php echo __('Local Contact Number - 6')?></div>
		    <div class="col-md-6">
		        <?php echo $this->Form->input('c_local_number_6',array('class'=>'form-control contact_number',
																											'type' =>'text',
																											'required' =>false,
																											'label'=>false,
																											'div'	 => false)); ?>
		...
		<?php if(isset($lang_list) && !empty($lang_list)){ 
						foreach($lang_list as $key=>$val){ ?>
							<div class="row">
		           <div class="col-md-3"></div>
		       		 <div class="col-md-6">Freetexts for <?php echo $val['Language']['title'];?></div>
		           <div class="col-md-3">&nbsp;</div>
		      	  </div>
		       <div class="clear10"></div>		
		<?php			echo $this->Form->input('CardsFreeText.cf_alias.',array('type'=>'hidden','value'=>isset($this->request->data['CardsFreeText']['cf_alias'][$key]) ? $this->request->data['CardsFreeText']['cf_alias'][$key] :$val['Language']['alias']));
							...
							for($i=1;$i<=6;$i++){ //create 6 free text for each language?> 
									<div class="row">
		                <div class="col-md-3"><?php echo __('Free Text '.$i)?></div>
		                <div class="col-md-6">
		                     <?php echo $this->Form->input('CardsFreeText.cf_freetext'.$i.'.',array('class'=>'form-control',
		                                                                'type' =>'text',
		                                                                'label'=>false,
		                                                                'div'	 => false,
		...
		<div class="row">
		  <div class="col-md-3"><?php echo __('Webpage')?></div>
		  <div class="col-md-6">
		       <?php echo $this->Form->input('c_webpage',array('class'=>'form-control url',
																											'type' =>'text',
																											'label'=>false,
																											'div'	 => false,
																											'required' =>false)); ?>
		...
		<div class="row">
		    <div class="col-md-3"><?php echo __('Card Inventory Threshold')?><sup class="MandatoryFields">*</sup></div>
		    <div class="col-md-6">
		        <?php echo $this->Form->input('c_inventory_threshold',array('class'=>'form-control contact_number',
																											'type' =>'text',
																											'required' =>true,
																											'label'=>false,
																											'div'	 => false)); ?>
		...
		<div class="row">
		    <div class="col-md-3"><?php echo __('PINs per card')?><sup class="MandatoryFields">*</sup></div>
		    <div class="col-md-6">
		        <?php echo $this->Form->input('c_pin_per_card',array('class'=>'form-control contact_number',
																											'type' =>'text',
																											'required' =>true,
																											'label'=>false,
																											'div'	 => false)); ?>
		...
		<?php	if(isset($this->request->data['Card']['c_image']) && !is_array($this->request->data['Card']['c_image'])){
		          ...
		          <div class="row">
		             ...
		             <div class="col-md-6">
								 		<?php  
										       echo $this->Html->image('card_icons/'.$this->request->data['Card']['c_image'],
																					array('alt'=>'Card','class'=>'','border'=>'0','div'=>true));?>
		             </div>
		             <div class="col-md-3">&nbsp;</div>
		          </div>
		          <div class="clear10"></div>
