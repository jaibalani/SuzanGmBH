     ...
     <?php if(isset($all_cat) && !empty($all_cat)){ 
				if(count($all_cat) > 9){ ?>
                  <div id="sb_scroll_btn">
                      <a id="prev_btn" class="buttons prev lanslideleftarrow" href="#">&lt;</a>
                     <a  id="next_btn" class="buttons next lansliderightarrow" href="#">&gt;</a>
                 </div> 
     <?php } }?>
    </div>  
   </div> 
                        ...
                        <div id="other-filter">
                            <div id="sb_selected_card">
                                <div class="left-part"><strong>Total Cards<span id="sb_total_card"> ( <?php echo @$total_cards_pagination;?> )</span></strong></div>
                            </div>
                            <div id="selected-filter">
                                <div class="left-part">
                                    <div id="append_selection" style="float:left;">Your Selection:</div>
                                    <!--<div class="selected-name">Adidas by Stella Mccartney &nbsp;&nbsp;<small>X</small></div>
                                    <div class="selected-name">Adidas by Stella Mccartney &nbsp;&nbsp;<small>X</small></div>-->
                                </div>
                                <div class="right-part">
                                    <div id = "clear_filter">Clear all filters  &nbsp;&nbsp;<small>X</small></div>
                                </div>
                            </div>
...
-->                                        </div>
                                ...
                                <div class="right-part">
                                    <button name="search" class="button-gradient search-by-filter">Search</button>
                                </div>
