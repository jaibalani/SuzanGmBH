...
-->
 <!-- <div class="sub_title"><i class="icon-list-alt home_icon"></i> <span class="sub_litle_m">PIN Management</span> <i class="icon-angle-right home_icon"></i> <span>Merged Pins</span></div>-->

  <div class="sub_title"><i class="icon-list-alt home_icon"></i> <span class="sub_litle_m">Product Master</span> <i class="icon-angle-right home_icon"></i> <span>Card Management</span> <i class="icon-angle-right home_icon"></i> <span>Unmerge Pins</span></div>


  <div class="main_subdiv">
    <div class="gird_button">
        <div class="main_sub_title merge2_w"><?php echo $title; ?></div>
        <button class="new_button mar_right" id="add_button" type="button"><span class="icon-plus icon-white"></span>&nbsp;&nbsp;Unmerge</button>
...
$(document).ready(function (){
	...
	$("#add_button").click(function(){
		window.location = "<?php echo Router::url(array('controller'=>'Pins','action'=>'admin_unmerge',$id,$card_id));?>";
	});
		$('.back').click(function(){
		history.go(-1);
