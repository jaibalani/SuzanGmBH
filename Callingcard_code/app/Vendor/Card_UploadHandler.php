...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'max_width' => 'Image exceeds maximum width 1760px.',
        'min_width' => 'Image requires a minimum width 110px.',
        'max_height' => 'Image exceeds maximum height 2480px',
        'min_height' => 'Image requires a minimum height 70px.'
    );

    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/img/card_icons/',
            'upload_url' => $this->get_full_url().'/img/card_icons/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            // 110px X 70px and maximum 1760px X 2480px in 'jpg','jpeg','png' and 'gif' for
            'max_width' => 1760,
            'max_height' => 2480,
            'min_width' => 110,
            'min_height' => 70,
