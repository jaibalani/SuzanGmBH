...
class UploadHandler
{
    ...
    // http://php.net/manual/en/features.file-upload.errors.php
     protected $error_messages = array(
        ...
        'accept_file_types' => 'Please provide valid image file.',
        'max_number_of_files' => 'Maximum number of files exceeded',
        'max_width' => 'Required image resolution for home page is 1600px X 850px.',
        'min_width' => 'Required image resolution for home page is 1600px X 850px.',
        'max_height' => 'Required image resolution for home page is 1600px X 850px.',
        'min_height' => 'Required image resolution for home page is 1600px X 850px.'
    );

    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/img/front_images/',
            'upload_url' => $this->get_full_url().'/img/front_images/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            //'accept_file_types' => '/.+$/i',
            'accept_file_types' => '/(\.|\/)(jpg|jpeg||gif|png)$/i',
