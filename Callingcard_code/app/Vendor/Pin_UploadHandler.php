...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'accept_file_types' => 'Please provide valid excel file.',
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/img/admin_uploads/pins_uploaded/',
            'upload_url' => $this->get_full_url().'/img/admin_uploads/pins_uploaded/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function get_unique_filename($name, $type, $index, $content_range) {
        ...
        while(is_file($this->get_upload_path($name))) {
            ...
            $name = $this->upcount_name($name);
				...
				$_SESSION['upload_pin_excel'] = $name;
		    return $name;
    }
