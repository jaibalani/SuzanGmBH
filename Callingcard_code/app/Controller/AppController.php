...
*/	
	...
	public function beforeFilter() {				
		...
		$languages_flag_default= $this->get_language_data();
		$this->set('languages_flag_default',$languages_flag_default);
		...
		$hotline_number_front = $web_setting['Websetting']['value'];
		$this->set('hotline_number_front',$hotline_number_front);
    ...
    public function get_language_data(){
            ...
            $languages_flag_default =array();
           
            foreach($record as $r)
            {
                $language_alias = $r['Language']['alias'];

                $languages_flag_default[$language_alias] = $r['Language']['language_flag'];
            }
    	    return $languages_flag_default;
    }
  ...
  public function update_cards_pins_details($card_id){
   ...
   public function admin_update_cards_pins_details($card_id){
   ...
   public function admin_redirect_to_dashboard_distributor(){
   		if($this->Auth->User('role_id') != 1)
   		{
            $this->Session->setFlash(__('You are not authorized to access the page.'), 
   ...
   public function admin_redirect_to_dashboard_mediator(){
